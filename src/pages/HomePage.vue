  ...
  <v-app>
    ...
    <v-main>
      <v-container class="mt-6">
        <h1 class="text-h5 mb-4">ホーム</h1>

        <v-btn color="primary" class="ma-2" :to="`/a/123`">Page A</v-btn>
        <v-btn color="success" class="ma-2" to="/b">Page B</v-btn>
        ...
        <v-btn color="info" class="ma-2" to="/g">Page g</v-btn>
